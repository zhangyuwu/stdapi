...
void (*os_isr)(void) = (void *)0;
void (*os_fiq)(void) = (void *)0;

void OS_CPU_HookISR(void (*routine)(void))
{
	os_isr = routine;
}

void OS_CPU_HookFIQ(void (*routine)(void))
{
	os_fiq = routine;
}
